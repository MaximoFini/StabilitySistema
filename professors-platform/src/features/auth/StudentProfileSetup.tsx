...
export default function StudentProfileSetup() {
    ...
    // Watch height and weight for IMC calculation
    const height = step4Form.watch("height")
    const weight = step4Form.watch("weight")
    const bmi = calculateBMI(weight, height)
    const bmiInfo = getBMIClassification(bmi)
        ...
        <div className="min-h-screen bg-background-light dark:bg-background-dark flex flex-col items-center justify-center p-4 relative overflow-x-hidden antialiased transition-colors duration-300">
            ...
            <main className="relative z-10 w-full max-w-[520px] flex flex-col gap-6">
                ...
                <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-[0_12px_40px_-12px_rgba(0,0,0,0.1)] border border-slate-100 dark:border-slate-700/50 p-6 sm:p-8 w-full">
                    ...
                    {currentStep === 3 && (
                        <form onSubmit={step3Form.handleSubmit(handleStep3Submit)} className="flex flex-col gap-5">
                    ...
                    {currentStep === 4 && (
                        <form onSubmit={step4Form.handleSubmit(handleStep4Submit)} className="flex flex-col gap-5">
                            <div className="mb-4 text-center sm:text-left">
                                <h2 className="text-xl sm:text-2xl font-bold text-[#101418] dark:text-white">
                            ...
                            {/* BMI Indicator */}
                            {bmi > 0 && (
                                <div className="p-4 bg-slate-50 dark:bg-[#0f1923] rounded-lg border border-slate-200 dark:border-slate-700">
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm font-medium text-[#5e758d] dark:text-slate-400">
                                            Índice de Masa Corporal (IMC)
                                        </span>
                                        <span className="text-2xl font-bold text-[#101418] dark:text-white">
                                            {bmi.toFixed(1)}
                                        </span>
                                    </div>
                                    <div className={`mt-2 text-sm font-medium ${bmiInfo.color}`}>
                    ...
                    {currentStep === 5 && (
                        <form onSubmit={step5Form.handleSubmit(handleStep5Submit)} className="flex flex-col gap-5">
                            <div className="mb-4 text-center sm:text-left">
                                <h2 className="text-xl sm:text-2xl font-bold text-[#101418] dark:text-white">
                            ...
                            <label className="flex flex-col gap-1.5 w-full">
                                ...
                                <textarea
                                    ...
                                    className="form-textarea flex w-full rounded-lg text-[#101418] dark:text-white bg-white dark:bg-[#0f1923] border border-[#dae0e7] dark:border-slate-600 focus:border-primary focus:ring-1 focus:ring-primary p-4 text-base transition-all outline-none resize-none"
                                    rows={3}
                                    maxLength={500}
                                />

                        ...
                        <div className="flex items-center gap-3 pb-2">
                            <div className="relative w-80">
                                ...
                                <input
                                    ...
                                    className="w-full h-9 pl-10 pr-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-white placeholder:text-slate-500 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none"
                            ...
                            {activeTab === 'routines' && (
                                <button
                                    ...
                                    className="h-9 px-4 bg-primary hover:bg-primary-dark text-white rounded-lg shadow-sm hover:shadow flex items-center justify-center gap-2 transition-all duration-200 font-medium text-sm whitespace-nowrap"
                                >

-- Training Plans Database Schema - CLEAN VERSION
-- Execute this SQL in Supabase SQL Editor

-- Drop tables first (this will automatically drop their policies)
...
-- Success message
SELECT 'Training schema created successfully! 🎉' as result;
